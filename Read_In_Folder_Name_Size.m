...
% 用于改变物体大小
Parameter_File.TargetWidth = Size_Range(i_Size);
Parameter_File.TargetHeight = Size_Range(i_Size);
...
Parameter_File.folder_Global = ['Data\Data-for-DR-FA\',Parameter_File.BackgroundType,'\Size\','Size-',num2str(Size_Range(i_Size))];
